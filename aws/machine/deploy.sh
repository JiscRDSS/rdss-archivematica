...
deploy_containers() {
    ...
    if [ "${MOCK_AWS}" != "true" ] ; then
        ...
        aws_var_exports="export RDSS_ADAPTER_DYNAMODB_ENDPOINT='' ; \
            ...
            export RDSS_ADAPTER_TABLE_CHECKPOINTS=\"${RDSS_ADAPTER_TABLE_CHECKPOINTS}\" ; \
            export RDSS_ADAPTER_TABLE_CLIENTS=\"${RDSS_ADAPTER_TABLE_CLIENTS}\" ; \
            export RDSS_ADAPTER_TABLE_METADATA=\"${RDSS_ADAPTER_TABLE_METADATA}\" ; \
            export RDSS_ADAPTER_CONSUMER_DYNAMODB_TABLE=\"${RDSS_ADAPTER_CONSUMER_DYNAMODB_TABLE}\" ; \
            export RDSS_ADAPTER_BROKER_REPOSITORY_DYNAMODB_TABLE=\"${RDSS_ADAPTER_BROKER_REPOSITORY_DYNAMODB_TABLE}\" ; \
